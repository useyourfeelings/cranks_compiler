...
int struct_test(){
    ...
    *p = 888 + 1;
    ...
    //printf("struct_test &a = 0x%x &b = 0x%x &c = 0x%x &d = 0x%x  s1.array = 0x%x  &s1.array[99] = 0x%x\n", &s1.a, &s1.b, &s1.c, &s1.d, s1.array, &s1.array[99]);


    //printf("struct_test 0x%x 0x%x\n", s1.array , 0x777);


    printf("struct_test %d %d %d %d %d\n", &s1.b - &s1.a, &s1.c - &s1.a, &s1.d - &s1.c, s1.array - &s1.a, &s1.array[99] - &s1.a);
...
int struct_test2(){
    ...
    sa1[6].aa = 222;
    sa1[6].s1.d = 333;
    printf("sa1[6].aa = %d sa1[6].s1.d = %d\n", sa1[6].aa, sa1[6].s1.d);
    ppp = &sa1[6];
    ppp->aa = 678;
    //printf("0x%x 0x%x 0x%x\n", sa1, ppp, &sa1[6]);
    printf("%d %d\n", ppp - sa1, &sa1[6] - ppp); // 832 *6 + 32*6 = 5184
    printf("%d %d %d\n", ppp->aa, sa1[6].aa, ppp->s1.d);
